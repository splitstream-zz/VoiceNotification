 ...
 */
public class ApplicationDetailsAdapter extends RecyclerView.Adapter<ApplicationDetailsAdapter.ViewHolder> implements ItemTouchHelperAdapter {
    ...
    public ApplicationDetailsAdapter(List<BundleKeyEntity> bundleKeys, OnStartDragListener onStartDragListener, Context context) {
    ...
    @Override
    public ApplicationDetailsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
